                    ...
                    <div class="user-list">
                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center">Lí do báo cáo</th>
                                    <th style="text-align: center">Thao tác</th>
                                </tr>
                            </thead>
                            <tbody>
                                <c:forEach items="${feedbacks}" var="o">
                                    <tr>
                                        <td style="text-align: center">${o.feedback_id}</td>
                                        <td style="text-align: center">${o.feedback_name}</td>
                                        <td style="text-align: center">${o.booking_id}</td>
                                        <td style="text-align: center">${o.feedback_rating}</td>
                                        <td style="text-align: center">${o.comment}</td>
                                        <td style="text-align: center">${o.feedback_day}</td>
                                        <td style="text-align: center">${o.reasonReport}</td>
                                        <td style="text-align: center">
                                            <div class="action-buttons">

                                                <button onclick="if (confirm('Bạn có chắc chắn muốn xóa?'))
                                                            window.location.href = 'delete-feedback?id=${o.feedback_id}'"
                                                        class="ban-button">
                                                    Xóa
                                                </button>

                                                <c:if test="${o.acc_type ne 4}">
                                                    <button onclick="if (confirm('Bạn có chắc chắn muốn khoá tài khoản?'))
                                                                window.location.href = 'ban-account?id=${o.acc_id}&action=feedbacks'"
                                                            class="ban-button">
                                                        Khóa tài khoản
                                                    </button>
                                                </c:if>
                        ...
                        <div class="pagination">
                            <c:if test="${currentPage > 1}">
                                <a href="feedbacks?page=${currentPage - 1}">&laquo;</a>
                            </c:if>

                            <c:forEach begin="1" end="${totalPages}" var="i">
                                <a href="feedbacks?page=${i}"
                                   class="${i == currentPage ? 'active' : ''}">${i}</a>
                            </c:forEach>

                            <c:if test="${currentPage < totalPages}">
                                <a href="feedbacks?page=${currentPage + 1}">&raquo;</a>
                            </c:if>
                        </div>
                    </div>
                </section>
