<%-- 
    Document   : forgot
    Created on : Sep 15, 2024, 10:10:01 AM
    Author     : Hung Bui
--%>
...
<html>
    ...
    <body>
        <div class="wrapper">
            ...
            <form action="ResetCodeServlet" method="post">
                <h1>Đổi mật khẩu</h1>
                <div class="input-box">
                    <input type="email" name="acc_email" placeholder="Nhập email mà bạn đã tạo" required>
