<%-- 
    Document   : footer
    Created on : Sep 8, 2024, 12:52:44 PM
    Author     : hadi
--%>
                    ...
                    <div id="footer-c">
                        ...
                        <div>
                            <div class="">
                                ...
                                <div class="module-content">
                                    <h3>ĐẶT PHÒNG KHÁCH SẠN - HOTELOKA</h3>

                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <p><strong>TRỤ SỞ&nbsp;ĐÀ NẴNG</strong></p>

                                            <p>514 29 tháng 3, P.&nbsp;Hòa Xuân, Q.&nbsp;Cẩm Lệ, Tp&nbsp;Đà Nẵng<br>
                                                Điện thoại:<strong>&nbsp;</strong><a href="tel:02363767588">0833100904</a>,<br>
                                                Hotline:&nbsp;<a href="tel:0966767588">0833 100904</a><br>
                                                <strong>Phản ánh&nbsp;dịch vụ: </strong><a href="tel:0777577555">0833 100 904</a><br>
                                                <strong>Số GPKD:</strong>&nbsp;00000000000&nbsp;<br>
                                                <strong>Số GPKD LH Quốc tế:&nbsp;</strong>00-111/2024/CDLQGVN-GPLHQT<br>
                                                <strong>Email:&nbsp;</strong>huynhde180295@fpt.edu.vn;<br>
                        ...
                        <div align="center">
                            <div class="hitsonline">
                                <p style="font-size: 25px; font-weight: bold; letter-spacing: 5px; color: #FFF; margin-right: -5px; text-shadow: 1px 1px 0 #212121">0833100904</p>
