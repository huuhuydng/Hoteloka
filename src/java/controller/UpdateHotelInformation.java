 ...
 * @author hadi
 */
@WebServlet(name = "UpdateHotelInformation", urlPatterns = {"/updatehotelinfo"})
public class UpdateHotelInformation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("updateHotelInfo.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String hotelType = new DAO().getTypeId(hotelType1);
        HttpSession session = request.getSession();
        String idHotel = request.getParameter("hotelId");
        System.out.println(hotelName + hotelType1 + hotelStar + hotelDesc + " " + idHotel);
        boolean isUpdate = new DAO().updateHotelInfo(idHotel,hotelName, hotelType, hotelStar, hotelDesc);
