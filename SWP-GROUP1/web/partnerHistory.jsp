            ...
            <nav>
                <ul>
                    ...
                    <li><a href="ChartServlet">
                            ...
                            <span style="margin-bottom: 20px" class="nav-item">Báo cáo</span>
                        </a></li>
                    <li><a href="home">
                        ...
                        <table class="table">
                            ...
                            <tbody>   
                                ...
                                <a style="background-color: #4caf50;
                                   color: white;
                                   text-align: center" href="javascript:void(0);" onclick="showRevenue()">Báo cáo Tổng Doanh thu</a>
                        <!-- Hiển thị tổng doanh thu sau khi tính toán -->
                        <div id="revenueReport" style="display: none;">
                            <h2 style="margin: 20px">Tổng doanh thu: <fmt:formatNumber value="${totalRevenue}" type="number" pattern="#,##0"/> VND</h2>
                        </div>
                    </div>
                </section>
            </section>
